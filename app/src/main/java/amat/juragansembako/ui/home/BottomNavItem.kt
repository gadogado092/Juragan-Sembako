...
sealed class BottomNavItem(var title: String, var icon: Int, var screen_route: String) {
    ...
    object Transaction : BottomNavItem("Transaksi", R.drawable.ic_baseline_home_24, "transaction")
    object Other : BottomNavItem("Lainnya", R.drawable.ic_baseline_home_24, "Other")
